...
class CarWorld extends JPanel {
	...
	Toolkit toolkit = Toolkit.getDefaultToolkit();
        ...
        redCar = toolkit.getImage("SWE-244/src/image/redcar.gif");
        mt.addImage(redCar, 0);
        blueCar = toolkit.getImage("SWE-244/src/image/bluecar.gif");
        mt.addImage(blueCar, 1);
        bridge = toolkit.getImage("SWE-244/src/image/bridge1.gif");
